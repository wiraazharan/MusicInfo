 ...
 */
public class HelperClassArtist {

    private static final String ArtistTopSongUrl =
            "http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist=";
    private static  final String secondhalf = "&api_key=0918574d4e587329e49934ab320c97b2&format=json";
            ...
            throws ApiException
    {
        ...
        String completerequest = ArtistTopSongUrl+param+secondhalf;



        // create an http client and a request object.
        HttpClient client = new DefaultHttpClient();
        HttpGet request = new HttpGet(completerequest);

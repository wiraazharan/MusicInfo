...
public class TopChartListviewAdapter extends BaseAdapter{
    ...
    private TopChart activity;

    private LayoutInflater layoutInflater;
    private ArrayList<DataTracker> tracks;


    public TopChartListviewAdapter (TopChart a,  LayoutInflater l, ArrayList<DataTracker> data)
    {
        this.activity = a;
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (TopChart.ViewHolder) convertView.getTag();
        }
